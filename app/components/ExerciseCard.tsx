...
type Props = {
  ...
  exercise: Exercise;
  sets: LocalSet[];
  draft: { weight: string; secondary: string };
  suggestion: OverloadSuggestion | null;
  weightUnit: 'kg' | 'lbs';
  onSwitch: () => void;
  onDelete: () => void;
  onDraftWeightChange: (value: string) => void;
  onDraftSecondaryChange: (value: string) => void;
  onConfirmDraft: () => void;
  ...
  return (
    <View style={{ backgroundColor: C.card, borderRadius: 16, borderWidth: 1, borderColor: C.borderAlt, overflow: 'hidden' }}>
      ...
      <View style={{ borderTopWidth: 1, borderTopColor: C.border }}>
        ...
        <DraftSetRow
          weight={draft.weight}
          secondaryValue={draft.secondary}
          loggingType={loggingType}
          onWeightChange={onDraftWeightChange}
          onSecondaryChange={onDraftSecondaryChange}
